...
class BeeWiseGameEngineImpl implements BeeWiseGameEngineDriver {
  ...
  static Future<BeeWiseGameEngineDriver> createEngine(
    ...
    return BeeWiseGameEngineImpl._(
  ...
  GuessedWordState trySubmitWord(String word) {
    ...
    if (uniqueLetters.length == BeeWiseConstants.numberOfLetters &&
  ...
  static String rankCalculator(Iterable<String> guessedWords) {
    ...
    return BeeWiseConstants.rankCalculator(score);
  }
